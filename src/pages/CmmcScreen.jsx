      ...
      <main className="security-main">
          ...
          <div className="custom-container">
            <div className="blog-hero-content text-start">
              ...
              <p className="blog-hero-subtitle max-w-780">
                Principal-led advisory support for defense contractors preparing
                for CMMC 2.0 certification and NIST SP 800-171 compliance under
                Department of Defense enforcement requirements.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <p className="sec-body-text1 mb-4 font-size-16 line-height-1-8">
                  CMMC 2.0 is a contractual obligation tied directly to
                  eligibility, Supplier Performance Risk System (SPRS) scoring
                  and formal assessment by a Certified Third-Party Assessor
                  Organization (C3PAO). Organizations handling Controlled
                  Unclassified Information (CUI) must demonstrate implemented
                  controls, structured System Security Plans (SSP) and
                  operational discipline aligned to NIST SP 800-171.
                </p>
                <p className="sec-body-text1 mb-5 font-size-16 line-height-1-8">
                  While our current operational focus centers on CMMC 2.0
                  readiness within the Defense Industrial Base, Spartan's
                  governance practice also supports ISO/IEC 27001 information
                  security management systems and ISO/IEC 42001 artificial
                  intelligence governance frameworks for regulated environments.
                </p>

                {/* Figma Callout Quote Component */}
                <div className="cmmc-callout-quote-box mt-4">
                  <p className="cmmc-quote-text">
                    We build defensible cybersecurity governance structures
                    aligned to
                    <br />
        ...
        <section className="cmmc-levels-section text-center">
          <div className="custom-container">
            ...
            <h2 className="section-main-heading font-weight-500 mb-3 max-w-900 mx-auto">
              Three Certification Levels – Level 2 is where most DIB awards
              land.
            </h2>
            <p className="section-subtitle-text mb-5 max-w-780 mx-auto">
              Every DoD contract maps to a CMMC level based on the type of
              information it touches.
              <br />
            ...
            <div className="row g-4 justify-content-center mb-5">
              ...
              <div className="col-lg-4 col-md-6">
                ...
                >
                  ...
                  <p className="card-level-desc">
                    17 basic safeguarding practices for FCI. Annual
                    self-assessment.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                ...
                >
                  ...
                  <p className="card-level-desc">
                    110 NIST SP 800-171 controls for CUI. Triennial C3PAO
                    assessment.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                ...
                >
                  ...
                  <p className="card-level-desc">
                    NIST SP 800-172 enhanced protections. DIBCAC-led government
                    assessment.
                  </p>
                </div>
              </div>
                ...
                <div className="d-flex flex-column gap-3">
                  <div className="cmmc-gap-pill">
                    <img
                      src={checkBulletRed}
                      alt="bullet"
                      className="gap-sparkle"
                    />
                    <span>
                      Access Control (AC) - identity, MFA, least privilege
                      across 22 controls
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Incident Response (IR) - detection, reporting and
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Personnel Security (PS) - screening and access termination
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Risk Assessment (RA) - vulnerability scanning and risk
                      tracking
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      System & Communications Protection (SC) - encryption,
                      boundary controls
                    </span>
                  </div>
                </div>
              ...
              <div className="col-md-6">
                <div className="d-flex flex-column gap-3">
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Audit & Accountability (AU) - log capture, retention, and
                      review
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Identification & Authentication (IA) - credential
                      lifecycle and MFA
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Media Protection (MP) - sanitization and CUI handling
                      discipline
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Physical Protection (PE) - facility and media controls
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      Security Assessment (CA) - SSP, POA&M and control
                      assessment
                    </span>
                  </div>
                  ...
                  <div className="cmmc-gap-pill">
                    ...
                    />
                    <span>
                      System & Information Integrity (SI) - flaw remediation and
                      monitoring
                    </span>
                  </div>
                </div>
        ...
        <section className="cmmc-enforcement-section text-center">
          <div className="custom-container">
            ...
            <p className="section-subtitle-text text-muted-gray mb-5 max-w-780 mx-auto font-size-15 line-height-1-7">
              The Department of Defense enforces CMMC 2.0 requirements through
              DFARS 252.204-7021 and DFARS 252.204-7025 contract clauses.
            </p>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-dark-panel-card">
                  <div className="dark-card-icon-wrapper">
                    <img
                      src={hammer}
                      alt="Gavel/Contract Icon"
                      className="dark-card-graphic-asset"
                    />
                  </div>
                  <h4 className="dark-card-title">Structured SSP</h4>
                  <p className="dark-card-desc">
                    Alignment with NIST SP 800-171 security requirements through
              ...
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-dark-panel-card">
                  <div className="dark-card-icon-wrapper">
                    <img
                      src={box}
                      alt="Clipboard Score Icon"
                      className="dark-card-graphic-asset"
                    />
                  </div>
                  <h4 className="dark-card-title">Accurate SPRS Scoring</h4>
                  <p className="dark-card-desc">
                    Supplier Performance Risk System scoring that matches
                    operational reality and assessor expectations.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-dark-panel-card">
                  <div className="dark-card-icon-wrapper">
                    <img
                      src={security}
                      alt="Shield Evaluation Icon"
                      className="dark-card-graphic-asset"
                    />
                  </div>
                  <h4 className="dark-card-title">C3PAO Assessment</h4>
                  <p className="dark-card-desc">
                    Readiness for formal evaluation by a Certified Third-Party
            ...
            <p className="section-subtitle-text text-muted-gray max-w-900 mx-auto font-size-15 mb-5 mt-2 opacity-85">
              This enforcement model shifts cybersecurity from self-attested
              documentation to independently evaluated operational capability.
            </p>
              ...
              <div className="col-12">
                <div className="cmmc-dark-warning-callout ps-4">
                  <p className="dark-warning-text">
                    CMMC 2.0 is not an advisory framework. It is a contractual
                    condition of participation within the Defense Industrial
                    Base.
                  </p>
                </div>
              </div>
        ...
        <section className="cmmc-evidence-section text-center padding-y-90">
          <div className="custom-container">
            <div className="section-tag-wrapper justify-content-center mb-3">
              <span className="section-mini-tag light-red-pill">
                <span className="fallback-red-dot"></span>AUDIT READINESS &
                EVIDENCE
              </span>
            </div>
            ...
            <p className="section-subtitle-text mb-5 max-w-780 mx-auto font-size-16">
              A standing evidence package ready for C3PAO sampling - not a
            ...
            <div className="row g-4 justify-content-center text-start mb-5">
                ...
                <div className="cmmc-evidence-card">
                  <div className="evidence-icon-box">
                    <img
                      ...
                      className="evidence-card-graphic"
                    />
                  </div>
                  <h4 className="evidence-card-title">Evidence Library</h4>
                  <p className="evidence-card-desc">
                    Live artifacts mapped to each of the 110 controls, refreshed
                    continuously and version-controlled.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-evidence-card">
                  ...
                  <p className="evidence-card-desc">
                    Full dry-run with finding response strategy and remediation
                    paths before the real assessor arrives.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-evidence-card">
                  ...
                  <p className="evidence-card-desc">
                    Senior advisor present during assessor visits - evidence
                    presentation, finding response, post-audit closure.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row text-start mt-5">
              <div className="col-12">
                <p className="sec-body-text1 mb-4 font-size-16 line-height-1-8">
                  We do not guarantee certification outcomes. Certification is
                  determined by formal assessment under CMMC 2.0 rules. Our role
                  is to ensure that systems, documentation and operational
                  practices are synchronized and defensible under structured
                  evaluation.
                </p>

                <div className="cmmc-callout-quote-box mt-4">
                  <p className="cmmc-quote-text">
                    CMMC 2.0 compliance is not a one-time event. It is an
                    enforceable condition of participation within the Defense
                    Industrial Base. Our approach is designed to withstand
                    scrutiny, not simply to satisfy checklists.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="cmmc-risk-section text-center pt-5">
          <div className="custom-container">
            ...
            <h2
              className="dark-section-title text-center"
              ...
              <div className="col-md-6 grid-item border-bottom">
                <div className="dark-list-item-with-icon">
                  ...
                  <div>
                    ...
                    <p>
                      Excluded from new DoD awards once the clause flows down.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 grid-item">
                <div className="dark-list-item-with-icon">
                  ...
                  <div>
                    ...
                    <p>
                      Post-failure remediation costs dwarf upfront investment.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="cmmc-gap-section text-center padding-y-90">
          <div className="custom-container">
            ...
            <p className="section-subtitle-text mb-5 max-w-780 mx-auto font-size-16">
              A structured readiness assessment mapped to NIST SP 800-171
              control families and C3PAO sampling logic.
            </p>
            ...
            <div className="row g-3 text-start">
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-gap-pill">
                  ...
                  />
                  <span>
                    Structured readiness assessments aligned to NIST SP 800-171
                    control families
                  </span>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="cmmc-gap-pill">
                  ...
                  />
                  <span>
                    SSP and POA&M development tied directly to scoring
                    methodology
                  </span>
                </div>
              </div>
        ...
        <section
          className="cmmc-executive-section text-start bg-white"
          ...
          <div className="custom-container">
            ...
            <div className="cmmc-left-accent-callout mb-4">
              <p className="accent-callout-text">
                CMMC 2.0 is not a marketing cycle. It is an enforceable
                condition of participation within the Defense Industrial Base.
              </p>
            </div>
            ...
            <div className="executive-body-content max-w-1100">
              <p className="sec-body-text1 mb-4 font-size-16 line-height-1-8">
                Organizations that approach compliance as documentation alone
                often discover weaknesses during formal evaluation.
                Organizations that approach it as governance discipline
                strengthen contract eligibility, operational resilience and
                executive accountability.
              </p>
              <p className="sec-body-text1 mb-5 font-size-16 line-height-1-8">
                Cybersecurity under CMMC 2.0 is not an IT initiative. It is a
                board-level risk management function tied directly to revenue
                continuity and contractual survival.
              </p>
            </div>
            ...
            <div className="spartan-signature-row d-flex align-items-center mt-2">
              <img
                src={spartanLogo}
                alt="Spartan Cyber Security Logo"
                className="signature-logo me-3"
              />
              <span className="signature-brand-text">
        ...
        <section
          className="cmmc-cta-section bg-white"
          ...
          <div className="custom-container">
            <div className="cmmc-radiant-cta-card text-center position-relative overflow-hidden">
              ...
              <h2 className="cta-display-title text-white font-weight-500 mb-3">
                Map your CMMC 2.0 path in a<br />
                Working Session.
              </h2>
              ...
              <p className="cta-display-subtitle mx-auto mb-5 max-w-700">
                ...
                fastest defensible route to certification.
              </p>
              ...
              <div className="cta-btn-group d-flex flex-sm-row flex-column align-items-center justify-content-center gap-3">
                <Link
                  to="/contact-us"
                  className="btn btn-white-action d-flex align-items-center justify-content-center"
                >
